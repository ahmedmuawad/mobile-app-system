        ...
        <form method="POST" action="{{ route('admin.wallet_transactions.update', $walletTransaction) }}">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="amount" class="form-control" value="{{ $walletTransaction->amount }}" step="0.01" required>
                </div>

                <div class="form-group">
                    <label for="commission">العمولة</label>
                    <input type="number" name="commission" class="form-control" value="{{ $walletTransaction->commission }}" step="0.01">
                </div>

                <div class="form-group">
                    <label for="target_number">رقم المستلم</label>
                    <input type="text" name="target_number" class="form-control" value="{{ $walletTransaction->target_number }}" placeholder="مثال: 01012345678">
                </div>
